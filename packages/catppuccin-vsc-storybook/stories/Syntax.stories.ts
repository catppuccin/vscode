...
export const Diff = StoryBuilder({ lang: "diff", file: "diff.diff" });
export const GDScript = StoryBuilder({ lang: "gdscript", file: "gdscript.gd" });
...
export const JavaScript = StoryBuilder({
  lang: "javascript",
  file: "javascript.js",
});
export const Json = StoryBuilder({ lang: "json", file: "json.json" });
export const JSX = StoryBuilder({ lang: "jsx", file: "jsx.jsx" });
...
export const Svelte = StoryBuilder({ lang: "svelte", file: "svelte.svelte" });
