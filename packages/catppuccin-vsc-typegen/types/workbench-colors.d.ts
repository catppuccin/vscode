...
export interface WorkbenchColors {
   ...
   */
  "actionBar.toggledBackground"?: _1 | string;
  /**
   ...
   */
  "activityBar.activeBackground"?: _1 | _6;
  /**
   ...
   */
  "activityBar.activeBorder"?: _1 | _5;
  /**
   ...
   */
  "activityBar.activeFocusBorder"?: _1 | _6;
  /**
   ...
   */
  "activityBar.inactiveForeground"?: _1 | string;
  /**
   ...
   */
  "activityBarBadge.background"?: _1 | _5;
  /**
   ...
   */
  "activityBarBadge.foreground"?: _1 | _27;
  /**
   ...
   */
  "activityBarTop.activeBackground"?: _1 | _6;
  /**
   ...
   */
  "activityBarTop.background"?: _1 | _6;
  /**
   ...
   * Color of focused breadcrumb items.
   */
  "breadcrumb.foreground"?: _1 | string;
  /**
   * Background color of breadcrumb item picker.
   */
  "breadcrumbPicker.background"?: _1 | _21;
  /**
   * Button background color.
   */
  "button.background"?: _1 | _5;
  /**
   * Button border color.
   */
  "button.border"?: _1 | string;
  /**
   * Button foreground color.
   */
  "button.foreground"?: _1 | _27;
  /**
   ...
   */
  "button.secondaryForeground"?: _0 | _1;
  /**
   * Secondary button background color when hovering.
   */
  "button.secondaryHoverBackground"?: _1 | _8;
  /**
   ...
   */
  "charts.yellow"?: _1 | _13;
  /**
   * The background color of a chat avatar.
   */
  "chat.avatarBackground"?: _1 | _19;
  /**
   ...
   */
  "chat.requestBackground"?: _1 | string;
  /**
   ...
   */
  "chat.slashCommandBackground"?: _1 | string;
  /**
   * The foreground color of a chat slash command.
   */
  "chat.slashCommandForeground"?: _1 | string;
  /**
   ...
   */
  "debugIcon.breakpointForeground"?: _1 | string;
  /**
   ...
   */
  "debugIcon.continueForeground"?: _1 | _33;
  /**
   ...
   */
  "debugIcon.pauseForeground"?: _1 | _33;
  /**
   ...
   */
  "debugIcon.stepBackForeground"?: _1 | _33;
  /**
   ...
   */
  "debugTokenExpression.boolean"?: _1 | _25;
  /**
   ...
   */
  "diffEditor.insertedLineBackground"?: _1 | string;
  /**
   ...
   */
  "diffEditor.removedTextBorder"?: _1 | _6;
  /**
   * The background color of unchanged code in the diff editor.
   */
  "diffEditor.unchangedCodeBackground"?: _1 | string;
  /**
   ...
   * Dropdown border.
   */
  "dropdown.border"?: _1 | _8;
  /**
   * Dropdown foreground.
   */
  "dropdown.foreground"?: _0 | _1;
  /**
   * Dropdown list background.
   */
  "dropdown.listBackground"?: _1 | _19;
  /**
   ...
   */
  "editor.foldPlaceholderForeground"?: _1 | string;
  /**
   * Editor default foreground color.
   */
  "editor.foreground"?: _0 | _1;
  /**
   * Highlight below the word for which a hover is shown. The color must not be opaque so as not to hide underlying decorations.
   */
  "editor.hoverHighlightBackground"?: _1 | string;
  /**
   * Color of the selection in an inactive editor. The color must not be opaque so as not to hide underlying decorations.
   */
  "editor.inactiveSelectionBackground"?: _1 | string;
  /**
   * Color for the debug inline value background.
   */
  "editor.inlineValuesBackground"?: _1 | string;
  /**
   ...
   */
  "editor.lineHighlightBackground"?: _1 | _6;
  /**
   * Background color for the border around the line at the cursor position.
   */
  "editor.lineHighlightBorder"?: _1 | string;
  /**
   * Background color when the editor auto renames on type.
   */
  "editor.linkedEditingBackground"?: _1 | _74;
  /**
   ...
   */
  "editor.rangeHighlightBackground"?: _1 | string;
  /**
   * Background color of the border around highlighted ranges.
   */
  "editor.rangeHighlightBorder"?: _1 | _6;
  /**
   * Color of the editor selection.
   */
  "editor.selectionBackground"?: _1 | _26;
  /**
   * Color of the selected text for high contrast.
   */
  "editor.selectionForeground"?: _1 | _6;
  /**
   * Color for regions with the same content as the selection. The color must not be opaque so as not to hide underlying decorations.
   */
  "editor.selectionHighlightBackground"?: _1 | string;
  /**
   * Border color for regions with the same content as the selection.
   */
  "editor.selectionHighlightBorder"?: _1 | _6;
  /**
   * Highlight background color of the final tabstop of a snippet.
   */
  "editor.snippetFinalTabstopHighlightBackground"?: _1 | _6;
  /**
   * Highlight border color of the final tabstop of a snippet.
   */
  "editor.snippetFinalTabstopHighlightBorder"?: _1 | string;
  /**
   * Highlight background color of a snippet tabstop.
   */
  "editor.snippetTabstopHighlightBackground"?: _1 | string;
  /**
   * Highlight border color of a snippet tabstop.
   */
  "editor.snippetTabstopHighlightBorder"?: _1 | _6;
  /**
   * Background color for the highlight of line at the top stack frame position.
   */
  "editor.stackFrameHighlightBackground"?: _1 | string;
  /**
   ...
   */
  "editor.symbolHighlightBackground"?: _1 | _28;
  /**
   * Background color of the border around highlighted symbols.
   */
  "editor.symbolHighlightBorder"?: _1 | _6;
  /**
   ...
   */
  "editor.wordHighlightBackground"?: _1 | _75;
  /**
   * Border color of a symbol during read-access, like reading a variable.
   */
  "editor.wordHighlightBorder"?: _1 | _6;
  /**
   ...
   */
  "editor.wordHighlightStrongBorder"?: _1 | _6;
  /**
   ...
   */
  "editor.wordHighlightTextBackground"?: _1 | _75;
  /**
   * Border color of a textual occurrence for a symbol.
   */
  "editor.wordHighlightTextBorder"?: _1 | _6;
  /**
   * Action List background color.
   */
  "editorActionList.background"?: _1 | _21;
  /**
   ...
   */
  "editorBracketHighlight.unexpectedBracket.foreground"?: _1 | string;
  /**
   * Background color behind matching brackets
   */
  "editorBracketMatch.background"?: _1 | string;
  /**
   * Color for matching brackets boxes
   */
  "editorBracketMatch.border"?: _1 | string;
  /**
   ...
   */
  "editorCommentsWidget.resolvedBorder"?: _1 | _2;
  /**
   * Color of borders and arrow for unresolved comments.
   */
  "editorCommentsWidget.unresolvedBorder"?: _1 | _5;
  /**
   * The background color of the editor cursor. Allows customizing the color of a character overlapped by a block cursor.
   */
  "editorCursor.background"?: _1 | _6;
  /**
   ...
   */
  "editorGroup.dropIntoPromptBackground"?: _1 | _21;
  /**
   ...
   */
  "editorGroup.dropIntoPromptBorder"?: _1 | _6;
  /**
   ...
   */
  "editorGroupHeader.noTabsBackground"?: _1 | _19;
  /**
   ...
   */
  "editorGroupHeader.tabsBorder"?: _1 | _9;
  /**
   ...
   */
  "editorGutter.background"?: _1 | _19;
  /**
   * Editor gutter decoration color for commenting glyphs.
   */
  "editorGutter.commentGlyphForeground"?: _0 | _1;
  /**
   ...
   */
  "editorGutter.commentUnresolvedGlyphForeground"?: _0 | _1;
  /**
   ...
   */
  "editorHint.border"?: _1 | _6;
  /**
   * Foreground color of hint squigglies in the editor.
   */
  "editorHint.foreground"?: _1 | string;
  /**
   * Background color of the editor hover.
   */
  "editorHoverWidget.background"?: _1 | _21;
  /**
   * Border color of the editor hover.
   */
  "editorHoverWidget.border"?: _1 | _22;
  /**
   * Foreground color of the editor hover.
   */
  "editorHoverWidget.foreground"?: _0 | _1;
  /**
   ...
   */
  "editorHoverWidget.statusBarBackground"?: _1 | _29;
  /**
   * Color of the active editor indentation guides.
   */
  "editorIndentGuide.activeBackground"?: _1 | string;
  /**
   * Color of the active editor indentation guides (1).
   */
  "editorIndentGuide.activeBackground1"?: _1 | string;
  /**
   ...
   */
  "editorIndentGuide.background"?: _1 | string;
  /**
   * Color of the editor indentation guides (1).
   */
  "editorIndentGuide.background1"?: _1 | string;
  /**
   ...
   */
  "editorInfo.background"?: _1 | _23;
  /**
   * If set, color of double underlines for infos in the editor.
   */
  "editorInfo.border"?: _1 | _6;
  /**
   * Foreground color of info squigglies in the editor.
   */
  "editorInfo.foreground"?: _1 | _24;
  /**
   * Background color of inline hints
   */
  "editorInlayHint.background"?: _1 | _31;
  /**
   * Foreground color of inline hints
   */
  "editorInlayHint.foreground"?: _1 | _30;
  /**
   * Background color of inline hints for parameters
   */
  "editorInlayHint.parameterBackground"?: _1 | _31;
  /**
   * Foreground color of inline hints for parameters
   */
  "editorInlayHint.parameterForeground"?: _1 | _30;
  /**
   * Background color of inline hints for types
   */
  "editorInlayHint.typeBackground"?: _1 | _31;
  /**
   * Foreground color of inline hints for types
   */
  "editorInlayHint.typeForeground"?: _1 | _30;
  /**
   * The color used for the lightbulb actions icon.
   */
  "editorLightBulb.foreground"?: _1 | _32;
  /**
   * The color used for the lightbulb AI icon.
   */
  "editorLightBulbAi.foreground"?: _1 | _32;
  /**
   * The color used for the lightbulb auto fix actions icon.
   */
  "editorLightBulbAutoFix.foreground"?: _1 | _33;
  /**
   * Color of editor active line number
   */
  "editorLineNumber.activeForeground"?: _0 | _1;
  /**
   * Color of the final editor line when editor.renderFinalNewline is set to dimmed.
   */
  "editorLineNumber.dimmedForeground"?: _1 | _6;
  /**
   * Color of editor line numbers.
   */
  "editorLineNumber.foreground"?: _1 | string;
  /**
   * Color of active links.
   */
  "editorLink.activeForeground"?: _1 | _25;
  /**
   * Editor marker navigation widget background.
   */
  "editorMarkerNavigation.background"?: _1 | _19;
  /**
   * Editor marker navigation widget error color.
   */
  "editorMarkerNavigationError.background"?: _1 | _14;
  /**
   * Editor marker navigation widget error heading background.
   */
  "editorMarkerNavigationError.headerBackground"?: _1 | _72;
  /**
   * Editor marker navigation widget info color.
   */
  "editorMarkerNavigationInfo.background"?: _1 | _24;
  /**
   * Editor marker navigation widget info heading background.
   */
  "editorMarkerNavigationInfo.headerBackground"?: _1 | _73;
  /**
   * Editor marker navigation widget warning color.
   */
  "editorMarkerNavigationWarning.background"?: _1 | _13;
  /**
   * Editor marker navigation widget warning heading background.
   */
  "editorMarkerNavigationWarning.headerBackground"?: _1 | string;
  /**
   ...
   */
  "editorMultiCursor.primary.background"?: _1 | _6;
  /**
   ...
   */
  "editorMultiCursor.secondary.background"?: _1 | _6;
  /**
   ...
   */
  "editorOverviewRuler.addedForeground"?: _1 | string;
  /**
   * Background color of the editor overview ruler.
   */
  "editorOverviewRuler.background"?: _1 | _6;
  /**
   ...
   */
  "editorOverviewRuler.bracketMatchForeground"?: _1 | string;
  /**
   ...
   */
  "editorOverviewRuler.commonContentForeground"?: _1 | string;
  /**
   * Current overview ruler foreground for inline merge-conflicts.
   */
  "editorOverviewRuler.currentContentForeground"?: _1 | string;
  /**
   * Overview ruler marker color for deleted content.
   */
  "editorOverviewRuler.deletedForeground"?: _1 | string;
  /**
   ...
   */
  "editorOverviewRuler.findMatchForeground"?: _1 | string;
  /**
   * Incoming overview ruler foreground for inline merge-conflicts.
   */
  "editorOverviewRuler.incomingContentForeground"?: _1 | string;
  /**
   * Overview ruler marker color for infos.
   */
  "editorOverviewRuler.infoForeground"?: _1 | _24;
  /**
   ...
   */
  "editorOverviewRuler.inlineChatRemoved"?: _1 | string;
  /**
   * Overview ruler marker color for modified content.
   */
  "editorOverviewRuler.modifiedForeground"?: _1 | string;
  /**
   * Overview ruler marker color for range highlights. The color must not be opaque so as not to hide underlying decorations.
   */
  "editorOverviewRuler.rangeHighlightForeground"?: _1 | string;
  /**
   ...
   */
  "editorOverviewRuler.warningForeground"?: _1 | _13;
  /**
   ...
   */
  "editorOverviewRuler.wordHighlightStrongForeground"?: _1 | string;
  /**
   ...
   */
  "editorPane.background"?: _1 | _19;
  /**
   * Color of the editor rulers.
   */
  "editorRuler.foreground"?: _1 | string;
  /**
   * Background color of sticky scroll in the editor
   */
  "editorStickyScroll.background"?: _1 | _19;
  /**
   * Border color of sticky scroll in the editor
   */
  "editorStickyScroll.border"?: _1 | _6;
  /**
   ...
   */
  "editorSuggestWidget.background"?: _1 | _21;
  /**
   * Border color of the suggest widget.
   */
  "editorSuggestWidget.border"?: _1 | _22;
  /**
   ...
   */
  "editorSuggestWidget.foreground"?: _0 | _1;
  /**
   ...
   */
  "editorWhitespace.foreground"?: _1 | string;
  /**
   * Background color of editor widgets, such as find/replace.
   */
  "editorWidget.background"?: _1 | _21;
  /**
   * Border color of editor widgets. The color is only used if the widget chooses to have a border and if the color is not overridden by a widget.
   */
  "editorWidget.border"?: _1 | _22;
  /**
   * Foreground color of editor widgets, such as find/replace.
   */
  "editorWidget.foreground"?: _0 | _1;
  /**
   * Border color of the resize bar of editor widgets. The color is only used if the widget chooses to have a resize border and if the color is not overridden by a widget.
   */
  "editorWidget.resizeBorder"?: _1 | _6;
  /**
   * Overall foreground color for error messages. This color is only used if not overridden by a component.
   */
  errorForeground?: _1 | _3;
  /**
   * Background color for the remote badge in the extensions view.
   */
  "extensionBadge.remoteBackground"?: _1 | _5;
  /**
   * Foreground color for the remote badge in the extensions view.
   */
  "extensionBadge.remoteForeground"?: _1 | _27;
  /**
   * Button background color for extension actions.
   */
  "extensionButton.background"?: _1 | _5;
  /**
   * Button foreground color for extension actions.
   */
  "extensionButton.foreground"?: _1 | _27;
  /**
   ...
   */
  "extensionButton.prominentBackground"?: _1 | _5;
  /**
   * Button foreground color for extension actions that stand out (e.g. install button).
   */
  "extensionButton.prominentForeground"?: _1 | _27;
  /**
   ...
   */
  "extensionIcon.sponsorForeground"?: _1 | string;
  /**
   ...
   */
  "extensionIcon.verifiedForeground"?: _1 | _7;
  /**
   ...
   */
  "gitDecoration.conflictingResourceForeground"?: _1 | string;
  /**
   ...
   */
  "gitDecoration.submoduleResourceForeground"?: _1 | string;
  /**
   ...
   */
  "inlineChatDiff.inserted"?: _1 | string;
  /**
   * Background color of removed text in the interactive editor input
   */
  "inlineChatDiff.removed"?: _1 | string;
  /**
   ...
   */
  "inlineChatInput.border"?: _1 | _22;
  /**
   * Border color of the interactive editor input when focused
   */
  "inlineChatInput.focusBorder"?: _1 | _5;
  /**
   ...
   */
  "inlineEdit.gutterIndicator.background"?: _1 | string;
  /**
   ...
   */
  "inlineEdit.gutterIndicator.primaryForeground"?: _1 | _27;
  /**
   ...
   */
  "inlineEdit.gutterIndicator.secondaryForeground"?: _0 | _1;
  /**
   ...
   */
  "inlineEdit.modifiedChangedLineBackground"?: _1 | string;
  /**
   ...
   */
  "inputOption.activeForeground"?: _1 | _27;
  /**
   ...
   */
  "inputValidation.errorBackground"?: _1 | string;
  /**
   ...
   */
  "inputValidation.errorForeground"?: _1 | _6;
  /**
   * Input validation background color for information severity.
   */
  "inputValidation.infoBackground"?: _1 | string;
  /**
   ...
   */
  "inputValidation.infoForeground"?: _1 | _6;
  /**
   * Input validation background color for warning severity.
   */
  "inputValidation.warningBackground"?: _1 | string;
  /**
   ...
   */
  "inputValidation.warningForeground"?: _1 | _6;
  /**
   ...
   */
  "list.activeSelectionForeground"?: _1 | _27;
  /**
   ...
   */
  "list.activeSelectionIconForeground"?: _1 | _27;
  /**
   ...
   */
  "list.focusAndSelectionOutline"?: _1 | _6;
  /**
   ...
   */
  "list.focusBackground"?: _1 | _6;
  /**
   * List/Tree foreground color for the focused item when the list/tree is active. An active list/tree has keyboard focus, an inactive does not.
   */
  "list.focusForeground"?: _1 | _6;
  /**
   ...
   */
  "list.hoverBackground"?: _1 | _20;
  /**
   * List/Tree foreground when hovering over items using the mouse.
   */
  "list.hoverForeground"?: _1 | _6;
  /**
   ...
   */
  "list.inactiveFocusBackground"?: _1 | _6;
  /**
   ...
   */
  "list.inactiveFocusOutline"?: _1 | _6;
  /**
   ...
   */
  "list.inactiveSelectionForeground"?: _1 | _6;
  /**
   ...
   */
  "list.inactiveSelectionIconForeground"?: _1 | _6;
  /**
   ...
   */
  "list.warningForeground"?: _1 | _13;
  /**
   * Background color of the type filter widget in lists and trees.
   */
  "listFilterWidget.background"?: _1 | _21;
  /**
   ...
   */
  "menu.foreground"?: _0 | _1;
  /**
   * Background color of the selected menu item in menus.
   */
  "menu.selectionBackground"?: _1 | _5;
  /**
   * Border color of the selected menu item in menus.
   */
  "menu.selectionBorder"?: _1 | _6;
  /**
   * Foreground color of the selected menu item in menus.
   */
  "menu.selectionForeground"?: _1 | _27;
  /**
   * Color of a separator menu item in menus.
   */
  "menu.separatorBackground"?: _1 | _22;
  /**
   ...
   */
  "menubar.selectionBorder"?: _1 | _6;
  /**
   * Foreground color of the selected menu item in the menubar.
   */
  "menubar.selectionForeground"?: _0 | _1;
  /**
   ...
   */
  "merge.commonContentBackground"?: _1 | string;
  /**
   ...
   */
  "merge.commonHeaderBackground"?: _1 | string;
  /**
   ...
   */
  "merge.currentContentBackground"?: _1 | string;
  /**
   ...
   */
  "merge.currentHeaderBackground"?: _1 | string;
  /**
   ...
   */
  "merge.incomingContentBackground"?: _1 | string;
  /**
   ...
   */
  "merge.incomingHeaderBackground"?: _1 | string;
  /**
   * The background color for changes.
   */
  "mergeEditor.change.background"?: _1 | string;
  /**
   ...
   */
  "mergeEditor.changeBase.background"?: _1 | string;
  /**
   * The background color for word changes in base.
   */
  "mergeEditor.changeBase.word.background"?: _1 | string;
  /**
   * The foreground color for changes in input 1.
   */
  "mergeEditor.conflict.handled.minimapOverViewRuler"?: _1 | string;
  /**
   * The border color of handled focused conflicts.
   */
  "mergeEditor.conflict.handledFocused.border"?: _1 | string;
  /**
   * The border color of handled unfocused conflicts.
   */
  "mergeEditor.conflict.handledUnfocused.border"?: _1 | string;
  /**
   * The background color of decorations in input 1.
   */
  "mergeEditor.conflict.input1.background"?: _1 | string;
  /**
   * The background color of decorations in input 2.
   */
  "mergeEditor.conflict.input2.background"?: _1 | string;
  /**
   * The foreground color for changes in input 1.
   */
  "mergeEditor.conflict.unhandled.minimapOverViewRuler"?: _1 | string;
  /**
   * The border color of unhandled focused conflicts.
   */
  "mergeEditor.conflict.unhandledFocused.border"?: _1 | string;
  /**
   * The border color of unhandled unfocused conflicts.
   */
  "mergeEditor.conflict.unhandledUnfocused.border"?: _1 | string;
  /**
   * The background of the "Conflicting Lines" text.
   */
  "mergeEditor.conflictingLines.background"?: _1 | string;
  /**
   * Minimap background color.
   */
  "minimap.background"?: _1 | _6;
  /**
   * Color of pending edit regions in the minimap
   */
  "minimap.chatEditHighlight"?: _1 | string;
  /**
   ...
   */
  "notebook.inactiveSelectedCellBorder"?: _1 | _6;
  /**
   * The color of the notebook output container background.
   */
  "notebook.outputContainerBackgroundColor"?: _1 | _6;
  /**
   * The border color of the notebook output container.
   */
  "notebook.outputContainerBorderColor"?: _1 | _6;
  /**
   ...
   */
  "notebook.symbolHighlightBackground"?: _1 | string;
  /**
   ...
   */
  "outputView.background"?: _1 | _6;
  /**
   * Output view sticky scroll background color.
   */
  "outputViewStickyScroll.background"?: _1 | _6;
  /**
   ...
   */
  "panel.dropBorder"?: _0 | _1;
  /**
   * Input box border for inputs in the panel.
   */
  "panelInput.border"?: _1 | _9;
  /**
   ...
   */
  "panelSectionHeader.background"?: _1 | string;
  /**
   ...
   */
  "panelSectionHeader.border"?: _1 | _6;
  /**
   ...
   */
  "panelSectionHeader.foreground"?: _1 | _6;
  /**
   ...
   */
  "panelStickyScroll.border"?: _1 | _6;
  /**
   * Shadow color of sticky scroll in the panel.
   */
  "panelStickyScroll.shadow"?: _1 | _12;
  /**
   ...
   */
  "panelTitle.activeForeground"?: _0 | _1;
  /**
   ...
   */
  "panelTitle.inactiveForeground"?: _1 | _4;
  /**
   ...
   */
  "panelTitleBadge.background"?: _1 | _5;
  /**
   ...
   */
  "panelTitleBadge.foreground"?: _1 | _27;
  /**
   * Color of the peek view borders and arrow.
   */
  "peekView.border"?: _1 | _24;
  /**
   * Background color of the peek view editor.
   */
  "peekViewEditor.background"?: _1 | _19;
  /**
   ...
   */
  "peekViewEditor.matchHighlightBorder"?: _1 | _6;
  /**
   * Background color of the gutter in the peek view editor.
   */
  "peekViewEditorGutter.background"?: _1 | _19;
  /**
   ...
   */
  "peekViewResult.background"?: _1 | _19;
  /**
   * Foreground color for file nodes in the peek view result list.
   */
  "peekViewResult.fileForeground"?: _1 | _27;
  /**
   * Foreground color for line nodes in the peek view result list.
   */
  "peekViewResult.lineForeground"?: _1 | string;
  /**
   ...
   */
  "peekViewResult.selectionBackground"?: _1 | string;
  /**
   * Foreground color of the selected entry in the peek view result list.
   */
  "peekViewResult.selectionForeground"?: _1 | _27;
  /**
   ...
   */
  "quickInput.foreground"?: _0 | _1;
  "quickInput.list.focusBackground"?: _1 | string;
  /**
   ...
   */
  "quickInputList.focusForeground"?: _1 | _27;
  /**
   * Quick picker icon foreground color for the focused item.
   */
  "quickInputList.focusIconForeground"?: _1 | _27;
  /**
   ...
   */
  "radio.activeForeground"?: _1 | _27;
  /**
   * Background color of inactive radio option.
   */
  "radio.inactiveBackground"?: _1 | _6;
  /**
   ...
   */
  "radio.inactiveForeground"?: _1 | _6;
  /**
   ...
   */
  "scmGraph.historyItemHoverDefaultLabelBackground"?: _1 | _10;
  /**
   * History item hover default label foreground color.
   */
  "scmGraph.historyItemHoverDefaultLabelForeground"?: _0 | _1;
  /**
   ...
   */
  "scmGraph.historyItemHoverLabelForeground"?: _1 | _27;
  /**
   * History item reference color.
   */
  "scmGraph.historyItemRefColor"?: _1 | _24;
  /**
   ...
   */
  "scrollbar.shadow"?: _1 | _12;
  /**
   * Scrollbar slider background color when clicked on.
   */
  "scrollbarSlider.activeBackground"?: _1 | _17;
  /**
   * Scrollbar slider background color.
   */
  "scrollbarSlider.background"?: _1 | _15;
  /**
   * Scrollbar slider background color when hovering.
   */
  "scrollbarSlider.hoverBackground"?: _1 | _16;
  /**
   * Color of the text in the search viewlet's completion message.
   */
  "search.resultsInfoForeground"?: _1 | string;
  /**
   * Color of the Search Editor query matches.
   */
  "searchEditor.findMatchBackground"?: _1 | string;
  /**
   * Border color of the Search Editor query matches.
   */
  "searchEditor.findMatchBorder"?: _1 | _6;
  /**
   * Search editor text input box border.
   */
  "searchEditor.textInputBorder"?: _1 | _8;
  /**
   ...
   */
  "settings.checkboxBorder"?: _1 | _8;
  /**
   * Settings editor checkbox foreground.
   */
  "settings.checkboxForeground"?: _0 | _1;
  /**
   ...
   */
  "settings.textInputBorder"?: _1 | _8;
  /**
   * Settings editor text input box foreground.
   */
  "settings.textInputForeground"?: _0 | _1;
  /**
   ...
   */
  "sideBarSectionHeader.border"?: _1 | _9;
  /**
   ...
   */
  "sideBarSectionHeader.foreground"?: _0 | _1;
  /**
   ...
   */
  "sideBarStickyScroll.border"?: _1 | _6;
  /**
   * Shadow color of sticky scroll in the side bar.
   */
  "sideBarStickyScroll.shadow"?: _1 | _12;
  /**
   ...
   */
  "simpleFindWidget.sashBorder"?: _1 | _22;
  /**
   ...
   */
  "statusBarItem.errorForeground"?: _1 | _27;
  /**
   ...
   */
  "statusBarItem.focusBorder"?: _1 | _5;
  /**
   ...
   */
  "statusBarItem.offlineBackground"?: _1 | string;
  /**
   * Status bar item foreground color when the workbench is offline.
   */
  "statusBarItem.offlineForeground"?: _1 | _27;
  /**
   ...
   */
  "statusBarItem.prominentBackground"?: _1 | string;
  /**
   ...
   */
  "statusBarItem.prominentForeground"?: _0 | _1;
  /**
   ...
   */
  "statusBarItem.remoteBackground"?: _1 | _5;
  /**
   * Foreground color for the remote indicator on the status bar.
   */
  "statusBarItem.remoteForeground"?: _1 | _27;
  /**
   ...
   */
  "statusBarItem.warningBackground"?: _1 | string;
  /**
   ...
   */
  "statusBarItem.warningForeground"?: _1 | _27;
  /**
   ...
   */
  "symbolIcon.enumeratorMemberForeground"?: _1 | _33;
  /**
   ...
   */
  "tab.activeModifiedBorder"?: _1 | string;
  /**
   ...
   */
  "tab.selectedBorderTop"?: _1 | string;
  /**
   ...
   */
  "tab.selectedForeground"?: _1 | string;
  /**
   ...
   */
  "tab.unfocusedActiveBackground"?: _1 | _19;
  /**
   ...
   */
  "tab.unfocusedActiveBorder"?: _1 | _19;
  /**
   ...
   */
  "tab.unfocusedActiveBorderTop"?: _1 | _9;
  /**
   ...
   */
  "tab.unfocusedHoverBackground"?: _1 | _19;
  /**
   ...
   */
  "tab.unfocusedHoverBorder"?: _1 | _6;
  /**
   ...
   */
  "tab.unfocusedHoverForeground"?: _1 | _6;
  /**
   ...
   */
  "tab.unfocusedInactiveForeground"?: _1 | string;
  /**
   ...
   */
  "tab.unfocusedInactiveModifiedBorder"?: _1 | string;
  /**
   * 'Black' ANSI color in the terminal.
   */
  "terminal.ansiBlack"?: _1 | _12;
  /**
   * 'Blue' ANSI color in the terminal.
   */
  "terminal.ansiBlue"?: _1 | string;
  /**
   * 'BrightBlack' ANSI color in the terminal.
   */
  "terminal.ansiBrightBlack"?: _1 | string;
  /**
   * 'BrightBlue' ANSI color in the terminal.
   */
  "terminal.ansiBrightBlue"?: _1 | string;
  /**
   * 'BrightCyan' ANSI color in the terminal.
   */
  "terminal.ansiBrightCyan"?: _1 | string;
  /**
   * 'BrightGreen' ANSI color in the terminal.
   */
  "terminal.ansiBrightGreen"?: _1 | string;
  /**
   * 'BrightMagenta' ANSI color in the terminal.
   */
  "terminal.ansiBrightMagenta"?: _1 | string;
  /**
   * 'BrightRed' ANSI color in the terminal.
   */
  "terminal.ansiBrightRed"?: _1 | _14;
  /**
   ...
   */
  "terminal.ansiBrightYellow"?: _1 | string;
  /**
   * 'Cyan' ANSI color in the terminal.
   */
  "terminal.ansiCyan"?: _1 | string;
  /**
   * 'Green' ANSI color in the terminal.
   */
  "terminal.ansiGreen"?: _1 | string;
  /**
   * 'Magenta' ANSI color in the terminal.
   */
  "terminal.ansiMagenta"?: _1 | string;
  /**
   * 'Red' ANSI color in the terminal.
   */
  "terminal.ansiRed"?: _1 | string;
  /**
   ...
   */
  "terminal.dropBackground"?: _1 | string;
  /**
   ...
   */
  "terminal.findMatchBackground"?: _1 | string;
  /**
   * Border color of the current search match in the terminal.
   */
  "terminal.findMatchBorder"?: _1 | _6;
  /**
   ...
   */
  "terminal.findMatchHighlightBackground"?: _1 | _28;
  /**
   * Border color of the other search matches in the terminal.
   */
  "terminal.findMatchHighlightBorder"?: _1 | _6;
  /**
   * The foreground color of the terminal.
   */
  "terminal.foreground"?: _0 | _1;
  /**
   * Border color of the other search matches in the terminal.
   */
  "terminal.hoverHighlightBackground"?: _1 | string;
  /**
   * The selection background color of the terminal when it does not have focus.
   */
  "terminal.inactiveSelectionBackground"?: _1 | string;
  /**
   ...
   */
  "terminal.selectionBackground"?: _1 | _26;
  /**
   ...
   */
  "terminalCursor.background"?: _1 | _6;
  /**
   * The foreground color of the terminal cursor.
   */
  "terminalCursor.foreground"?: _1 | _6;
  /**
   ...
   */
  "testing.coverCountBadgeBackground"?: _1 | _10;
  /**
   * Foreground for the badge indicating execution count
   */
  "testing.coverCountBadgeForeground"?: _1 | _11;
  /**
   ...
   */
  "testing.coveredBorder"?: _1 | string;
  /**
   ...
   */
  "testing.message.error.badgeBackground"?: _1 | _14;
  /**
   * Border color of test error messages shown inline in the editor.
   */
  "testing.message.error.badgeBorder"?: _1 | _14;
  /**
   * Text color of test error messages shown inline in the editor.
   */
  "testing.message.error.badgeForeground"?: _1 | _12;
  /**
   * Margin color beside error messages shown inline in the editor.
   */
  "testing.message.error.lineBackground"?: _1 | _6;
  /**
   * Text color of test info messages shown inline in the editor.
   */
  "testing.message.info.decorationForeground"?: _1 | _2;
  /**
   * Margin color beside info messages shown inline in the editor.
   */
  "testing.message.info.lineBackground"?: _1 | _6;
  /**
   * Color of the peek view borders and arrow when peeking a logged message.
   */
  "testing.messagePeekBorder"?: _1 | _24;
  /**
   * Color of the peek view borders and arrow when peeking a logged message.
   */
  "testing.messagePeekHeaderBackground"?: _1 | _73;
  /**
   * Color of the peek view borders and arrow.
   */
  "testing.peekBorder"?: _1 | _14;
  /**
   * Color of the peek view borders and arrow.
   */
  "testing.peekHeaderBackground"?: _1 | _72;
  /**
   ...
   */
  "testing.uncoveredBorder"?: _1 | string;
  /**
   * Background of the widget shown for an uncovered branch.
   */
  "testing.uncoveredBranchBackground"?: _1 | string;
  /**
   * Gutter color of regions where code not covered.
   */
  "testing.uncoveredGutterBackground"?: _1 | _74;
  /**
   * Background color for block quotes in text.
   */
  "textBlockQuote.background"?: _1 | _9;
  /**
   * Border color for block quotes in text.
   */
  "textBlockQuote.border"?: _1 | _10;
  /**
   * Background color for code blocks in text.
   */
  "textCodeBlock.background"?: _1 | _9;
  /**
   * Foreground color for links in text when clicked on and on mouse hover.
   */
  "textLink.activeForeground"?: _1 | _7;
  /**
   * Foreground color for links in text.
   */
  "textLink.foreground"?: _1 | _7;
  /**
   * Background color for preformatted text segments.
   */
  "textPreformat.background"?: _1 | _8;
  /**
   * Foreground color for preformatted text segments.
   */
  "textPreformat.foreground"?: _1 | string;
  /**
   * Color for text separators.
   */
  "textSeparator.foreground"?: _1 | string;
  /**
   ...
   */
  "titleBar.activeForeground"?: _0 | _1;
  /**
   * Title bar border color.
   */
  "titleBar.border"?: _1 | _9;
  /**
   * Title bar background when the window is inactive.
   */
  "titleBar.inactiveBackground"?: _1 | _19;
  /**
   * Title bar foreground when the window is inactive.
   */
  "titleBar.inactiveForeground"?: _1 | _4;
  /**
   * Toolbar background when holding the mouse over actions
   */
  "toolbar.activeBackground"?: _1 | string;
  /**
   ...
   */
  "toolbar.hoverOutline"?: _1 | _6;
  /**
   * Tree stroke color for the indentation guides that are not active.
   */
  "tree.inactiveIndentGuidesStroke"?: _1 | string;
  /**
   ...
   */
  "tree.tableColumnsBorder"?: _1 | string;
  /**
   ...
   */
  "walkThrough.embeddedEditorBackground"?: _1 | string;
  /**
   * Foreground color of the heading of each walkthrough step
   */
  "walkthrough.stepTitle.foreground"?: _1 | _27;
  /**
   * Background color for the Welcome page.
   */
  "welcomePage.background"?: _1 | _6;
  /**
   ...
   */
  "welcomePage.progress.foreground"?: _1 | _5;
  /**
   * Background color for the tiles on the Welcome page.
   */
  "welcomePage.tileBackground"?: _1 | _9;
  /**
   ...
   */
  "welcomePage.tileHoverBackground"?: _1 | _29;
  /**
