...
let
  ...
  yarnBin = fetchurl {
    url = "https://repo.yarnpkg.com/4.7.0/packages/yarnpkg-cli/bin/yarn.js";
    hash = "sha512-Wgr6HUwdhEs0R+4zGWM3l7zWOF2aRL4HmTrlL/T6yrzK+0r13NHC+alKwRPl6f9W9hMEMZBYhEFCKeKE43u3yQ==";
  };
