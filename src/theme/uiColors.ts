...
export const getUiColors = (context: ThemeContext) => {
  ...
  return {
    ...
    "debugIcon.breakpointCurrentStackframeForeground": palette.base,
    "debugIcon.breakpointStackframeForeground": palette.base,
    ...
    "debugIcon.stepOverForeground": palette.base,
