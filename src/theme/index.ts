...
export const compileTheme = (
    ...
    const theme = {
        ...
        colors: {
            ...
            "editor.findRangeHighlightBackground": opacity(
                palette.surface2,
                0.3
            ),
            ...
            "editor.lineHighlightBackground": opacity(palette.text, 0.05),
            ...
            "editorOverviewRuler.border": opacity(palette.text, 0.05),
            ...
            "peekViewTitleDescription.foreground": opacity(
                palette.subtext1,
                0.7
            ),
