...
export const compileTheme = (
    ...
    const theme = {
        ...
        colors: {
            ...
            "statusBarItem.hoverBackground": `${palette.text}1f`,
            ...
            "titleBar.inactiveBackground": `${palette.base}91`,
            "titleBar.inactiveForeground": `${palette.text}80`,
            ...
            "input.placeholderForeground": `${palette.text}70`,
            ...
            "editorWhitespace.foreground": `${palette.overlay2}18`,
            "editor.selectionHighlightBackground": `${palette.overlay2}5e`,
            "editor.selectionHighlightBorder": `${palette.sky}30`,
            "editor.findMatchBackground": palette.surface2,
            "editor.findMatchBorder": `${palette.blue}6a`,
            "editor.findMatchHighlightBackground": `${palette.peach}5e`,
            "editor.findMatchHighlightBorder": transparent,
            "editor.findRangeHighlightBackground": `${palette.surface2}48`,
            "editor.findRangeHighlightBorder": transparent,
            "editor.rangeHighlightBackground": `${palette.sky}3c`,
            "editor.rangeHighlightBorder": transparent,
            "editor.hoverHighlightBackground": `${palette.sky}3c`,
            "editor.wordHighlightStrongBackground": palette.surface2,
            "editor.wordHighlightBackground": `${palette.surface2}b8`,
            "editor.lineHighlightBackground": `${palette.text}0A`,
            ...
            "editorBracketMatch.background": `${palette.overlay2}14`,
            "editorBracketMatch.border": palette.overlay2,
            "editor.foldBackground": `${palette.sky}42`,
            "editorOverviewRuler.background": palette.mantle,
            "editorOverviewRuler.border": `${palette.text}0F`,
            ...
            "diffEditor.insertedTextBackground": `${palette.green}18`,
            "diffEditor.removedTextBackground": `${palette.red}1c`,
            ...
            "panelTitle.inactiveForeground": `${palette.text}ad`,
            ...
            "breadcrumb.foreground": `${palette.text}cd`,
            ...
            "scrollbarSlider.background": `${palette.surface2}7e`,
            "scrollbarSlider.hoverBackground": palette.overlay0,
            "scrollbarSlider.activeBackground": `${palette.surface0}66`,
            "progressBar.background": palette.blue,
            "widget.shadow": `${palette.base}80`,
            ...
            "peekViewEditor.matchHighlightBackground": `${palette.peach}40`,
            ...
            "peekViewResult.matchHighlightBackground": `${palette.peach}40`,
            ...
            "peekViewTitleDescription.foreground": `${palette.subtext1}b3`,
            ...
            "statusBarItem.activeBackground": `${palette.text}25`,
            "settings.headerForeground": palette.text,
            "settings.focusedRowBackground": `${palette.text}07`,
            "walkThrough.embeddedEditorBackground": `${palette.base}50`,
